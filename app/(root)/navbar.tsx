    ...
    <nav className="bg-[#0a0f1a] flex shadow-lg sticky top-0 z-50 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link
            href="/source"
            className={`text-sm font-medium  hover:text-white-400 transition ${
        ...
        <div className="hidden md:flex items-center space-x-4">
          {session ? (
            ...
            <Link
              href="/login"
              className="text-sm font-medium px-4 py-1.5 rounded text-cyan-400 border border-cyan-500 hover:bg-cyan-500/10 transition"
            >
              Login
            </Link>
          )}
